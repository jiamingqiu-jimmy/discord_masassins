...
When you run out, contact the Gym Leaders for more (STEALING NAME TAGS IS FORBIDDEN!)
...
Do not report a schedule change to Gym Leaders (i.e. you add or drop a class, change your work schedule, etc.), your team will lose gold.
